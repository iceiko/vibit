...
在 `ADR-0150` 之后，近期优先级是 `M-171/W-0243 Select next Nakama prototype-ready capability after friends relationship route proof`。该 work 只应选择下一项 direction。
