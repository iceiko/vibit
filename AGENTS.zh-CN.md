...
在 `ADR-0152` 之后，近期优先级是 `M-173/W-0245 Implement minimum operations inspection source-first surface`。该 work 必须保持在 source-first operations inspection gate 内。
