...
`M-016 Runtime Authentication Implementation Boundary Planning` is completed. The active gate is `M-017 Authentication Generated Contract Shape Gate`, with `W-0088 Decide authentication generated contract shape timing` as the next ready work item. This gate may decide whether generated Go authentication contract shapes should be introduced before application service interfaces and runtime authentication behavior; it does not authorize generated authentication shape creation, runtime authentication behavior, Protobuf messages, WebSocket behavior, token generation, token validation, verifier comparison, login, logout execution, refresh, cleanup jobs, or authentication dependencies.
...
`../decisions/ADR-0037-close-runtime-auth-boundary-and-open-generated-shape-gate.md` closes M-016 and opens M-017. W-0088 may decide generated authentication contract shape timing only; it must not generate files or add runtime behavior.
