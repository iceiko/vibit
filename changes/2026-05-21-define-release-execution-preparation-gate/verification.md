...
- `node tools/vibit inspect next` passed and reports `M-120/W-0192 Define release execution authorization gate` as next ready.
- `node tools/vibit check change define-release-execution-preparation-gate --json` passed.
