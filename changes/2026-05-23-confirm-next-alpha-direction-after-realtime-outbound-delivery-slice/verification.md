...
node tools/vibit inspect rule runtime.next_alpha_direction_after_realtime_outbound_delivery_slice
node tools/vibit check change confirm-next-alpha-direction-after-realtime-outbound-delivery-slice --json
...
- `node tools/vibit inspect next --json` passed and reported `M-148/W-0220 Define agent-native feature request and test workflow` as next ready.
- `node tools/vibit inspect rule runtime.next_alpha_direction_after_realtime_outbound_delivery_slice` passed.
- `node tools/vibit check change confirm-next-alpha-direction-after-realtime-outbound-delivery-slice --json` passed.
