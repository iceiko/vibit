...
- `node tools/vibit check work --json`
  ...
  - warnings: 0
  - failures: 0
- `node tools/vibit check change define-verifier-digest-comparison-helper-gate --json`
  - passed: 13
  - warnings: 0
  - failures: 0
...
- Verifier digest comparison behavior is not verified because this gate intentionally does not add comparison code.
