...
- Before this change, `node tools/vibit inspect rule runtime.pitaya_aligned_backend_service_route_ownership_boundary_gate` failed with `Unknown rule_id: runtime.pitaya_aligned_backend_service_route_ownership_boundary_gate`.
