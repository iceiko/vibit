...
- `node tools/vibit check change confirm-next-milestone-direction --json`
...
- Go tests; this confirmation step does not change Go source.
- Live PostgreSQL verification; this confirmation step does not run PostgreSQL.
