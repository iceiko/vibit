...
TEST_PATTERN='TestAuthenticatedGameplayE2EUsesExistingOnboardingLoginBindingInventoryPresenceAndLogout|TestStorageObjectsProtocolRouteLocalAlphaFlow|TestPresenceStatusLocalAlphaFlowReportsOfflineAfterCloseAndInvalidation|TestAuthenticatedGameplayFailurePathsLocalAlphaFlow'
...
printf '%s\n' "path: local onboarding -> login -> bind connection -> protected inventory/presence/storage -> logout -> rejected protected request"
