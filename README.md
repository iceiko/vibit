...
`ADR-0179` registered `runtime.pitaya_aligned_runtime_observability_boundary_gate`, completed `W-0271 Define Pitaya-aligned runtime observability boundary gate`, selected `implement_pitaya_aligned_runtime_observability_source_first_map`, and opened `W-0272 Implement Pitaya-aligned runtime observability source-first map` as next-ready.

The next direction is `implement_pitaya_aligned_runtime_observability_source_first_map`.
