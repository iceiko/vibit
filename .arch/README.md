...
`contracts.yaml` registers public command, query, event, error, and permission contract source files. Contract files live under `contracts/` and are source artifacts, not generated output.
