...
After `ADR-0151`, the near-term priority is `M-172/W-0244 Define minimum operations inspection surface gate`. Keep that work to gate definition only.
