...
After `ADR-0154`, the near-term priority is `M-175/W-0247 Implement Pitaya-aligned distributed runtime vocabulary source-first map`. Keep that work to a source-first vocabulary map; do not implement cluster/RPC/service-discovery behavior until a later bounded work item authorizes it.
