...
After `ADR-0153`, the near-term priority is `M-174/W-0246 Define Pitaya-aligned distributed runtime vocabulary reactivation gate`. Keep that work to gate-only architecture vocabulary; do not implement cluster/RPC/service-discovery behavior until a later bounded work item authorizes it.
