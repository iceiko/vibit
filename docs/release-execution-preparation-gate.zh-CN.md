...
该 future step 可以定义 release execution 的 authorization criteria，但仍不得发布 release 或创建 release artifacts，除非它自己的 scope 明确说明并且 maintainer 授权 ask-first boundary。
