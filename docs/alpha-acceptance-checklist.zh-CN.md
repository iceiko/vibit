...
- [x] `node tools/vibit inspect next` 能识别当前 `W-0224 Select next Nakama prototype-ready capability after authenticated failure-path proof` continuation step。
