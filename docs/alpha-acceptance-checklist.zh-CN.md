...
- [x] `node tools/vibit inspect next` 能识别当前 `W-0218 Implement realtime protocol and WebSocket outbound delivery slice` continuation step。
