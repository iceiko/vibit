...
- [x] `node tools/vibit inspect next` 能识别当前 `W-0267 Select next Pitaya-aligned direction after acceptor and connection lifecycle map` continuation step。
