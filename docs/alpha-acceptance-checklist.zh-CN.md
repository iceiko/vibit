...
- [x] `node tools/vibit inspect next` 能识别当前 `W-0264 Select next Pitaya-aligned direction after serializer and message forwarding map` continuation step。
