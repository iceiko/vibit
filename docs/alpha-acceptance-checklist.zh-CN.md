...
- [x] `node tools/vibit inspect next` 能识别当前 `W-0219 Confirm next alpha direction after realtime outbound delivery slice` continuation step。
