...
- [x] `node tools/vibit inspect next` 能识别当前 `W-0254 Define Pitaya-aligned distributed group and broadcast boundary gate` continuation step。
