# Pitaya-Aligned Distributed Presence Fanout Boundary Gate
...
The paired Simplified Chinese translation is `docs/pitaya-aligned-distributed-presence-fanout-boundary-gate.zh-CN.md`. The English file is authoritative.
