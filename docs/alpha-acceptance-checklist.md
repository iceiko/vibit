...
- [x] `node tools/vibit inspect next` identifies the current `W-0217 Define realtime protocol and WebSocket outbound delivery gate` continuation step.
