...
- [x] `node tools/vibit inspect next` identifies the current `W-0265 Define Pitaya-aligned acceptor and connection lifecycle boundary gate` continuation step.
