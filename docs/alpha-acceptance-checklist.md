...
- [x] `node tools/vibit inspect next` identifies the current `W-0255 Implement Pitaya-aligned distributed group and broadcast source-first map` continuation step.
...
next_direction: implement_pitaya_aligned_distributed_group_broadcast_source_first_map
