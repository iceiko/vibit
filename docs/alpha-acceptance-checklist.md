...
- [x] `node tools/vibit inspect next` identifies the current `W-0256 Define Pitaya-aligned cluster-safe session routing boundary gate` continuation step.
