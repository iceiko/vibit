...
- [x] `node tools/vibit inspect next` identifies the current `W-0243 Select next Nakama prototype-ready capability after friends relationship route proof` continuation step.
- [x] The current `next_direction: select_next_nakama_prototype_ready_capability_after_friends_relationship_route_proof` follows the completed friends relationship protocol route local proof.
