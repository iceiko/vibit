...
- [x] `node tools/vibit inspect next` identifies the current `W-0224 Select next Nakama prototype-ready capability after authenticated failure-path proof` continuation step.
