...
- [x] `node tools/vibit inspect next` identifies the current `W-0247 Implement Pitaya-aligned distributed runtime vocabulary source-first map` continuation step.
