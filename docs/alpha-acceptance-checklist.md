...
- [x] `node tools/vibit inspect next` identifies the current `W-0218 Implement realtime protocol and WebSocket outbound delivery slice` continuation step.
