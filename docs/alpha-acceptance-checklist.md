...
- [x] `node tools/vibit inspect next` identifies the current `W-0261 Select next Pitaya-aligned direction after route handler pipeline map` continuation step.
