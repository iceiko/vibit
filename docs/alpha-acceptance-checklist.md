...
- [x] `node tools/vibit inspect next` identifies the current `W-0266 Implement Pitaya-aligned acceptor and connection lifecycle source-first map` continuation step.
