...
- [x] `node tools/vibit inspect next` identifies the current `W-0267 Select next Pitaya-aligned direction after acceptor and connection lifecycle map` continuation step.
