...
- [x] `node tools/vibit inspect next` identifies the current `W-0227 Select next Nakama prototype-ready capability after local alpha example client path` continuation step.
