...
- [x] `node tools/vibit inspect next` identifies the current `W-0260 Implement Pitaya-aligned route handler pipeline source-first map` continuation step.
