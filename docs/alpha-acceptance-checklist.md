...
- [x] `node tools/vibit inspect next` identifies the current `W-0262 Define Pitaya-aligned serializer and message forwarding boundary gate` continuation step.
