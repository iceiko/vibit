...
- [x] `node tools/vibit inspect next` identifies the current `W-0258 Select next Pitaya-aligned direction after cluster-safe session routing map` continuation step.
