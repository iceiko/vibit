...
- [x] `node tools/vibit inspect next` identifies the current `W-0249 Implement Pitaya-aligned frontend/backend role source-first map` continuation step.
