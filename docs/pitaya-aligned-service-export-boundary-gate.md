# Pitaya-Aligned Service Export Boundary Gate
...
The paired Simplified Chinese translation is `docs/pitaya-aligned-service-export-boundary-gate.zh-CN.md`. The English file is authoritative.
