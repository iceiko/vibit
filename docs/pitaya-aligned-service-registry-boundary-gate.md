# Pitaya-Aligned Service Registry Boundary Gate
...
The paired Simplified Chinese translation is `docs/pitaya-aligned-service-registry-boundary-gate.zh-CN.md`. The English file is authoritative.
