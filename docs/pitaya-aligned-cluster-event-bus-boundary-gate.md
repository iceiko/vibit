# Pitaya-Aligned Cluster Event Bus Boundary Gate
...
The paired Simplified Chinese translation is `docs/pitaya-aligned-cluster-event-bus-boundary-gate.zh-CN.md`. The English file is authoritative.
