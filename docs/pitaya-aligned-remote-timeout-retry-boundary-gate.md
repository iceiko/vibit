# Pitaya-Aligned Remote Timeout Retry Boundary Gate
...
The paired Simplified Chinese translation is `docs/pitaya-aligned-remote-timeout-retry-boundary-gate.zh-CN.md`. The English file is authoritative.
