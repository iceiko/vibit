# Pitaya-Aligned Frontend Message Forwarding Boundary Gate
...
The paired Simplified Chinese translation is `docs/pitaya-aligned-frontend-message-forwarding-boundary-gate.zh-CN.md`. The English file is authoritative.
