# Pitaya-Aligned Cross-Node Error Mapping Boundary Gate
...
The paired Simplified Chinese translation is `docs/pitaya-aligned-cross-node-error-mapping-boundary-gate.zh-CN.md`. The English file is authoritative.
