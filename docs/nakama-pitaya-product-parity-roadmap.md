...
next_work_item: W-0218 Implement realtime protocol and WebSocket outbound delivery slice
```
...
- Implement the realtime protocol and WebSocket outbound delivery slice. Next.
