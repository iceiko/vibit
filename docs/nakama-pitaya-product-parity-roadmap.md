...
- The next gate should define distributed group and broadcast vocabulary without adding group implementation, room broadcast fanout, distributed runtime behavior, service discovery behavior, RPC behavior, protocol shape, persistence, dependencies, or direct compatibility.
