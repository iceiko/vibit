...
- The next source-first map should make future Pitaya-aligned service discovery, registry, instance, and selector vocabulary inspectable before groups, parties, chat targeting, invites, matchmaking filters, or match runtime social context depend on broader scope.
