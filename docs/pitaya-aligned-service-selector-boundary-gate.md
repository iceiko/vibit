# Pitaya-Aligned Service Selector Boundary Gate
...
The paired Simplified Chinese translation is `docs/pitaya-aligned-service-selector-boundary-gate.zh-CN.md`. The English file is authoritative.
