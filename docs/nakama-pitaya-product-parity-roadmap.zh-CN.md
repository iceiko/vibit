...
pitaya_reference_status: route_handler_pipeline_source_first_map_implemented
...
next_work_item: W-0262 Define Pitaya-aligned serializer and message forwarding boundary gate
```
