# Pitaya-Aligned Route Targeting Boundary Gate
...
The paired Simplified Chinese translation is `docs/pitaya-aligned-route-targeting-boundary-gate.zh-CN.md`. The English file is authoritative.
