# Pitaya-Aligned Remote Call Dispatch Boundary Gate
...
The paired Simplified Chinese translation is `docs/pitaya-aligned-remote-call-dispatch-boundary-gate.zh-CN.md`. The English file is authoritative.
